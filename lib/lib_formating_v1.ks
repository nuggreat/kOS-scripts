...
// FUNCTION padding  {
  ...
  // IF trailingLength > 0 {
	...
	// LOCAL newString IS splitString[0]:PADLEFT(leadingLength) + ".".
    // IF splitString:LENGTH = 1 {
	  // SET newString TO newString + " ":PADRIGHT(trailingLength).
    // } ELSE {
	  // SET newString TO newString + splitString[1]:PADRIGHT(trailingLength).
	// }
	
	// SET returnString TO newString:REPLACE(" ","0").
