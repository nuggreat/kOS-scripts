...
//SET beeper:ATTACK TO 0.
//SET beeper:DECAY TO 0.
//SET beeper:SUSTAIN TO 1.
...
FUNCTION adv_print {
	...
	LOCAL coddedTest IS parse(plainText,char_to_code).
	LOCAL compositions IS compose(coddedTest).
	IF doSound {
