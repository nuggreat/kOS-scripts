...
// This is done by comparing how long since the last staging event against the stageSequence list in the data structure generated by staging_start
// The function must be passed the data structure generated by the staging_start function
// The function returns true when it has staged secesfully and will return false in all other cases
...
// If the returned number is positave then it means staging is that many seconds in the future
// If the returned number is negitave then it means staging is that many seconds in the past
